...
def generate_complex_plan():
    # Create contracts
    token = Contract(DemoContract("0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", "USDC"))
    vault = Contract(DemoContract("0x3Fe65692bfCD0e6CF84cB1E7d24108E434A7587e", "Vault"))
    farm = Contract(DemoContract("0x8B3d70d628Ebd30D4A2ea82DB95bA2e906c71633", "Farm"))
...
def main():
    ...
    print(
        f"Reconstructed planner: {len(reconstructed_planner.commands)} commands, {len(reconstructed_planner.state)} state entries"
    )
