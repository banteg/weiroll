...
from eth_utils import function_signature_to_4byte_selector, is_address, to_bytes, to_checksum_address

from .command import CommandArg
from .constants import CallType
from .exceptions import EmptyABIError, InvalidContractError
...
class ContractFunction:
    ...
    def __init__(self, contract: "Contract", fn_name: str, fn_sig: str, call_type: CallType = CallType.DELEGATECALL):
...
class FunctionCall:
    ...
    def staticcall(self) -> "FunctionCall":
        ...
        result = ContractFunction(self.fn.contract, self.fn.fn_name, self.fn.fn_sig, CallType.STATICCALL)
...
class Contract:
    ...
    def __init__(self, address: str, abi: list[dict[str, Any]] | None, call_type: CallType = CallType.CALL):
