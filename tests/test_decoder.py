...
Command[2]: DAI Vault @ 0xd8063123BBA3B480569244AE66BFE72B6c84b00d [CALL]
    ...
    ├─ uint256 shares:   State[2] <- Command[1] output
    ├─ address receiver: State[0] = 0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045
